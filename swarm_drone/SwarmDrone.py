    ...
    def __init__(self,ip_list=None,points=None,v=20,start_pos_drone=None,sim=False
        ...
        if not sim:
            ...
            for i, tello in enumerate (self.swarm):
                    ...
                    self.tello_yaw.append(tello.get_yaw())
            ...
            if  use_camera and green_rectangle_info is not None:
                ...
                self.real_width=green_rectangle_info['width']
                self.real_high=green_rectangle_info['high']
...
curve_info={"num_points":9,"size":180,"start_point":[0,0],"img":binary_img,"resolution":0}  
